...
public class JayesCallModel implements ICallModel {
    ...
    public List<Recommendation<IMethodName>> getRecommendedCalls(RecommendationsProcessor<IMethodName> processor) {
        ...
        return firstNonNull(processor, Recommendations.<IMethodName> defaultProcessor()).process(recs);
    }
    ...
    public List<Recommendation<String>> getRecommendedPatterns(RecommendationsProcessor<String> processor) {
        ...
        return firstNonNull(processor, Recommendations.<String> defaultProcessor()).process(recs);
    }
